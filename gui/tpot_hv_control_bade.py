...
def tpot_lv_elink_recovery_wizard():
    ...
    confirm = yes_no_dialog(
        root,
      "Elink Recovery Wizard",
      "This will power-cycle all TPOT Low Voltage channels, run the reconfiguration procedure and perform configuration checks.\n\n"
      "This process takes about 10 minutes and CANNOT run in parallel with TPC Step 2.\n\n"
    ...
    # Reconfiguration launcher
    result = subprocess.run(
        [bin_lv_path + "/tpot_reconfiguration_launcher.sh"],
...
def main():
  ...
  button_lv_elink_wizard = generic_button(buttonframe, text="Elink Recovery Wizard")
