...
def main():
  ...
  parser = argparse.ArgumentParser(
    prog = 'tpot_hv_set_rup.py',
    epilog = '')
  
  parser.add_argument(
    'value', 
    type=float,
    help='the value to assign to RUP')
  
  parser.add_argument(
    'channels', 
    type=str,
    help='a list of channels to which RUP is assigned, e.g. NCOP_D SEW_R1...',
    nargs='+' )
  ...
  print( f'this will set RUP to {value}V/s for the following channels: {ch_names}' )
